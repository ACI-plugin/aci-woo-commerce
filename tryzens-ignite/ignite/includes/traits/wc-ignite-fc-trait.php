<?php
/**
 * File for WC_Ignite_Fc_Trait class
 *
 * @package ignite
 */
...
/**
 * Trait for WC_Ignite_Fc_Trait
 */
trait WC_Ignite_Fc_Trait {
	/**
	 * To get FC params for Gpay and ApplePay
	 */
	public function get_fc_params() {
		$gateways           = WC()->payment_gateways()->payment_gateways();
		$fc_gateway         = $gateways['woo_ignite_fc'];
		...
		$fc_params = array(
			...
			'entity_id'                  => $fc_gateway->get_fc_entity_id(),
