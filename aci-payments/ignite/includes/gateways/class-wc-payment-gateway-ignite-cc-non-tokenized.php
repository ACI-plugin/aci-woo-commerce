...
class WC_Payment_Gateway_Ignite_CC_Non_Tokenized extends WC_Payment_Gateway_Ignite {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Ignite Card Settings', 'woocommerce' );
	...
	public function process_payment( $order_id ) {
		...
		try {
			...
			$merchant_transaction_id = isset( $response['merchantTransactionId'] ) ? $response['merchantTransactionId'] : '';
			$success                 = false;
			...
			$order->add_meta_data( 'merchant_transaction_id', $merchant_transaction_id, true );
